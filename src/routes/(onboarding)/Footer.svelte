<script lang="ts">
	import { Card, Frame, A, P, type LinkType } from 'flowbite-svelte';
	import {
		DiscordSolid,
		DribbbleSolid,
		FacebookSolid,
  ...
  const frameClass = `
    ${maxWidth}
    mx-4 my-2 rounded-lg bg-transparent p-4 dark:bg-gray-800 
    md:flex md:items-center md:justify-between md:p-2 xl:p-3
  `;
</script>

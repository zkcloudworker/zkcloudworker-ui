<script lang="ts">
	...
	let posts = [
		{ name: 'Home', icon: PieChartSolid, href: '/dashboard' },
		{
			name: 'My Space',
			icon: TableColumnSolid,
			children: {
				// Stacked: '/layouts/stacked',
				'My Credentials': '/layouts/sidebar',
				'My Claims': '/layouts/sidebar',
				'My communities': '/layouts/sidebar',
				'My tasks': '/layouts/sidebar'
			}
		},
		{
			name: 'Running',
		...
		},
		{
			...
			icon: RectangleListSolid,
			children: {
				'MINA Navigators': '/crud/products',
				'MINA Validators': '/crud/users'
			}
		},
...
<Sidebar
	...
	asideClass="fixed inset-0 z-30 flex-none h-full w-full lg:w-64 lg:h-auto border-e border-gray-200 dark:border-gray-600 lg:overflow-y-visible lg:pt-16 lg:block"
>
